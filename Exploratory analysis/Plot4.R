...
plot(data$x,as.numeric(data$Global_active_power),type="l",xlab="",ylab="Global Active Power")

plot(data$x,as.numeric(data$Voltage),type="l",ylab="Voltage",xlab="datetime")
...
plot(data$x,as.numeric(data$Global_reactive_power),type="l",xlab="datetime",ylab="Global_reactive_power")
